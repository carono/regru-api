 ...
 * Generator: parser_api.php
 * @source https://www.reg.ru/support/help/api2
 */
abstract class absClient extends BaseClient
{
	 ...
	 * @return mixed
	 */
	public function folderNop($folder)
	{
		$params = [
			'folder' => $folder
		];
	 ...
	 * @return mixed
	 */
	public function folderRemove($folder)
	{
		$params = [
			'folder' => $folder
		];
	 ...
	 * @return mixed
	 */
	public function folderRename($newFolder, $folder)
	{
		$params = [
			'newFolder' => $newFolder,
			'folder' => $folder
	 ...
	 * @return mixed
	 */
	public function folderAddServices($return_folder_contents, $services, $folder)
	{
		$params = [
	 ...
	 * @return mixed
	 */
	public function folderRemoveServices($return_folder_contents, $services, $folder)
	{
		$params = [
			'return_folder_contents' => $return_folder_contents,
			'services' => $services,
	 ...
	 * @return mixed
	 */
	public function folderReplaceServices($return_folder_contents, $services, $folder)
	{
		$params = [
			'return_folder_contents' => $return_folder_contents,
			'services' => $services,
	 ...
	 * @return mixed
	 */
	public function folderMoveServices($return_folder_contents, $services, $newFolder, $folder)
	{
		$params = [
			'return_folder_contents' => $return_folder_contents,
			'services' => $services,
